...
## Corpus Check
- 115 files · ~47,101 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 721 nodes · 1355 edges · 40 communities (33 shown, 7 thin omitted)
...
Cohesion: 0.06
Nodes (88): GET(), POST(), schema, actionSchema, Context, PATCH(), GET(), input (+80 more)
...
Cohesion: 0.07
Nodes (53): main(), prisma, required, stages, Ctx, PATCH(), POST(), POST() (+45 more)
...
- **Why does `prisma` connect `fromApiError` to `knowledge.ts`, `auth/route.ts`, `conversations/[id]/route.ts`?**
...
- **Should `fromApiError` be split into smaller, more focused modules?**
  _Cohesion score 0.05549306336707911 - nodes in this community are weakly interconnected._
