# Graph Report - omnichannel-crm  (2026-09-09)

## Corpus Check
- 116 files · ~47,355 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 726 nodes · 1359 edges · 42 communities (34 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `08ccc344`
...
Cohesion: 0.06
Nodes (84): GET(), POST(), schema, actionSchema, Context, PATCH(), GET(), input (+76 more)
...
### Community 4 - "auth/route.ts"
Cohesion: 0.10
Nodes (24): GET(), POST(), DELETE(), GET(), POST(), POST(), AppLayout(), Home() (+16 more)
...
### Community 8 - "EA Global Water staging walkthrough and sign-off"
Cohesion: 0.40
Nodes (4): Client sign-off, Completed before client review, EA Global Water staging walkthrough and sign-off, Walkthrough
...
Cohesion: 0.10
Nodes (33): main(), main(), GET(), Context, DELETE(), PATCH(), runtime, GET() (+25 more)
...
Cohesion: 0.08
Nodes (48): main(), prisma, required, stages, GET(), PATCH(), Ctx, PATCH() (+40 more)
...
## Knowledge Gaps
- **335 isolated node(s):** `__filename`, `__dirname`, `compat`, `eslintConfig`, `nextConfig` (+330 more)
...
- **Why does `prisma` connect `fromApiError` to `knowledge.ts`, `conversations/[id]/route.ts`, `auth/route.ts`?**
...
- **Should `fromApiError` be split into smaller, more focused modules?**
  _Cohesion score 0.05826446280991736 - nodes in this community are weakly interconnected._
